...
export const patioPackageAdditions = [
  {
    image: '/assets/images/accessory-types/fire-pit.png',
    value: PatioPackageAddition.FirePit,
    label: 'Fire Pit',
  },
  {
  ...
  {
    image: '/assets/images/accessory-types/pillars.png',
    value: PatioPackageAddition.Pillars,
    label: 'Pillars',
  },
  {
    image: '/assets/images/accessory-types/lighting.png',
    value: PatioPackageAddition.WallLights,
    label: 'Wall Lights',
  },
  {
  ...
  {
    image: '/assets/images/accessory-types/curbing.png',
    value: PatioPackageAddition.Curbing,
    label: 'Curbing',
  },
  {
...
export class PatioPackageOption {
  ...
  price?: number;
  value?: any;
  pricetext?: string; //show price on front

  constructor(label: string, price?: number, value?: any, pricetext?: string) {
    this.label = label;
    this.price = price;
    this.value = value;
...
export function getPatioPackageAdditions(
  values: PatioPackageAddition[]
): { image: string; label: string; value: PatioPackageAddition }[] {
  return patioPackageAdditions.filter((option) =>
